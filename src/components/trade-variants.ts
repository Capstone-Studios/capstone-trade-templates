...
const ROOFER: TradeVariant = {
  slug: "roofer",
  label: "Roofing",
  palette: { primary: "#1B2559", accent: "#B45309", soft: "rgba(180, 83, 9, 0.08)" },
  hero: {
    style: "editorial",
...
const PLUMBER: TradeVariant = {
  slug: "plumber",
  label: "Plumbing",
  palette: { primary: "#0C4A6E", accent: "#0891B2", soft: "rgba(8, 145, 178, 0.10)" },
  hero: {
    style: "emergency",
...
const ELECTRICIAN: TradeVariant = {
  slug: "electrician",
  label: "Electrical",
  palette: { primary: "#1A1A1A", accent: "#F59E0B", soft: "rgba(245, 158, 11, 0.10)" },
  hero: {
    style: "classic",
...
const HVAC: TradeVariant = {
  ...
  palette: { primary: "#1E293B", accent: "#DC2626", soft: "rgba(220, 38, 38, 0.08)" },
  hero: {
    style: "emergency",
...
const LANDSCAPER: TradeVariant = {
  slug: "landscaper",
  label: "Landscaping",
  palette: { primary: "#14532D", accent: "#65A30D", soft: "rgba(101, 163, 13, 0.10)" },
  hero: {
    style: "portfolio",
...
const PAINTER: TradeVariant = {
  slug: "painter",
  label: "Painting",
  palette: { primary: "#1E1B4B", accent: "#8B5CF6", soft: "rgba(139, 92, 246, 0.10)" },
  hero: {
    style: "portfolio",
...
const GC: TradeVariant = {
  ...
  palette: { primary: "#292524", accent: "#CA8A04", soft: "rgba(202, 138, 4, 0.10)" },
  hero: {
    style: "portfolio",
...
const HANDYMAN: TradeVariant = {
  ...
  palette: { primary: "#0F172A", accent: "#EA580C", soft: "rgba(234, 88, 12, 0.10)" },
  hero: {
    style: "classic",
